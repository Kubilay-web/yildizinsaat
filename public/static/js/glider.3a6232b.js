        ...
        return {
          c: function () {
            (e = Object(r.o)("div")),
              ...
              Object(r.e)(
                o,
                "class",
                "glider-scrollbar__handle svelte-117nnr3"
              ),
          ...
          m: function (i, l) {
            Object(r.t)(i, e, l),
              ...
              n ||
                ((s = [
                  Object(r.v)(window, "resize", t[6]),
                  Object(r.v)(window, "mousemove", t[5]),
                  Object(r.v)(window, "mouseup", t[4]),
                  Object(r.v)(e, "mousedown", t[3]),
                ]),
                (n = !0));
          },
          p: function (t, n) {
            ...
            4 & s && Object(r.e)(o, "style", t[2]),
              2 & s &&
                i !== (i = "opacity: ".concat(t[1] < 1 ? 1 : 0)) &&
                Object(r.e)(e, "style", i);
          },
          i: r.x,
          o: r.x,
          d: function (o) {
            o && Object(r.n)(e), t[15](null), (n = !1), Object(r.A)(s);
          },
        };
      }
      function h(t, e, o) {
        var n,
          ...
          l = e.glider,
          a = l.ele,
          c = a.querySelector(".glider-track"),
          d = null,
          u = 0,
          f = 0,
          p = a.offsetWidth,
        ...
        return (
          ...
          (t.$$.update = function () {
            3072 & t.$$.dirty && o(1, (n = p / h)),
              24577 & t.$$.dirty &&
                o(9, (f = (b - m) / (d ? d.offsetWidth : 1))),
              6018 & t.$$.dirty &&
                v &&
                (o(8, (u = parseInt(100 * f) - 5)),
                o(8, (u /= n)),
            ...
            var t = "undefined" != typeof window ? window : this,
              e = (t.Glider = function (e, o) {
                ...
                if (
                  ...
                  for (
                    r.track = document.createElement("div"),
                      r.ele.appendChild(r.track);
                    1 !== r.ele.children.length;
            ...
            return (
              (o.init = function (t, e) {
                ...
                "auto" === o.opt.slidesToScroll &&
                  ...
                  (n || e) && (o.bindArrows(), o.buildDots(), o.bindDrag()),
                  o.updateControls(),
              ...
              (o.buildDots = function () {
                ...
                if (t.opt.dots) {
                  if (
                    ("string" == typeof t.opt.dots
                      ? (t.dots = document.querySelector(t.opt.dots))
                      : (t.dots = t.opt.dots),
                    t.dots)
                  ) {
                    (t.dots.innerHTML = ""),
                    ...
                    for (
                      var e = 0;
                      e < Math.ceil(t.slides.length / t.opt.slidesToShow);
                      ++e
                    ) {
                ...
                t.opt.arrows
                  ? ["prev", "next"].forEach(function (e) {
                      ...
                      o &&
                        ...
                        o &&
                          ((o._func = o._func || t.scrollItem.bind(t, e)),
                          t.event(o, "remove", {
                            click: o._func,
                          }),
                          t.event(o, "add", {
                ...
                1 === Math.floor(e.opt.slidesToShow) && (i = 0),
                      ...
                      r === o || (i && i === o)
                        ...
                        : (n.remove("center"),
                          n.add(
                            [
                              o < r ? "left" : "right",
                              Math.abs(o - (o < r ? r : i || r)),
                            ].join("-")
                          ));
                    var u =
                      Math.ceil(c) >= Math.floor(l) &&
                      Math.floor(d) <= Math.ceil(a);
                    n.toggle("visible", u),
                      u !== s &&
                        e.emit("slide-" + (u ? "visible" : "hidden"), {
                          slide: o,
                        });
                  }),
                  e.dots &&
                    [].forEach.call(e.dots.children, function (t, o) {
                  ...
                  t &&
                    ...
                    (e.scrollLock = setTimeout(function () {
                      clearTimeout(e.scrollLock),
                        Math.abs(e.ele.scrollLeft / e.itemWidth - e.slide) >
                          0.02 &&
                          (e.mouseDown ||
                            (e.trackWidth >
                              e.containerWidth + e.ele.scrollLeft &&
              ...
              (o.scrollItem = function (t, e, o) {
                    ...
                    if (
                      ...
                      t =
                        n && !s
                          ? r.slides.length
                          : !n &&
                            s + r.containerWidth >= Math.floor(r.trackWidth)
                          ? 0
                          : t;
                    }
                  }
                ...
                return (
                  r.scrollTo(
                    t,
                    r.opt.duration * Math.abs(r.ele.scrollLeft - t),
                    function () {
                      r.updateControls(),
                        r.emit("animated", {
                          value: i,
              ...
              (o.settingsBreakpoint = function () {
                ...
                return (
                  (e.opt = Object.assign({}, e._opt)), (e.breakpoint = 0), n
                );
              }),
              (o.scrollTo = function (e, o, r) {
                var i = this,
                  ...
                  l = function () {
                    ...
                    (i.ele.scrollLeft =
                      i.ele.scrollLeft +
                      (e - i.ele.scrollLeft) * i.opt.easing(0, a, 0, 1, o)),
                      a < o && s === i.animate_id
                        ? t.requestAnimationFrame(l)
                        : ((i.ele.scrollLeft = e), r && r.call(i));
                  };
                t.requestAnimationFrame(l);
              }),
              (o.removeItem = function (t) {
                var e = this;
                e.slides.length &&
                  (e.track.removeChild(e.slides[t]),
                  e.refresh(!0),
                  e.emit("remove"));
              }),
              ...
              (o.handleMouse = function (t) {
                ...
                e.mouseDown &&
                  ((e.isDrag = !0),
                  (e.ele.scrollLeft +=
                    (e.mouseDown - t.clientX) * (e.opt.dragVelocity || 3.3)),
