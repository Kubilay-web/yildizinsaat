    ...
    110: function (t, s, i) {
      ...
      class a {
        ...
        static settings(t, s) {
          ...
          return (
            NodeList.prototype.isPrototypeOf(t.el) && (t.el = Array.from(t.el)),
        ...
        animate() {
          this.monitor(),
            this.hasChanged() &&
              this.isVisible() &&
              (this.unchange(), this.measure(), this.update()),
        ...
        measure() {
          var t = this.compensate
            ? this.wtop / this.wheight
            : (this.wtop + this.wheight / 2 - this.origin()) /
        ...
        isVisible() {
          return (
            this.bottom + this.include > this.wtop &&
            this.top - this.include < this.wbottom
          );
        }
      }
      class e extends a {
        constructor(t, s) {
          super(), (this.el = t), this.init(s);
        }
        init(t) {
          this.reduceMotion ||
            ((this.compensate = !(
              "" !== this.el.dataset.parallaxCompensate && !t.compensate
            )),
        ...
        update() {
          this.parallax !== this.pparallax &&
            ((this.pparallax = this.parallax),
            this.hack
              ? (this.css.transform = "translate3d(0,".concat(
                  this.parallax,
                  "px,0)"
                ))
              : (this.css.transform = "translateY(".concat(
                  this.parallax,
                  "px)"
                )));
        }
      ...
      var h = function () {
        ...
        r = (t) => {
          ...
          if (0 === i) return a;
          for (var e = 0; e < i; e++)
            (a = (a << 5) - a + s.charCodeAt(e)), (a |= 0);
          return Math.abs(a).toString();
        },
        n = [];
      class o extends a {
        constructor(t, s) {
          super(), (this.wrap = t), this.init(s);
        }
        init(t) {
          var s =
              this.wrap.dataset.parallaxBackground ||
              this.wrap.dataset.parallaxBg,
            i = getComputedStyle(this.wrap).backgroundImage.replace(
              /url\("?([^)"]+)"?\)/,
              "$1"
            );
          this.reduceMotion
            ? "none" === i &&
              (this.wrap.style.backgroundImage = "url(".concat(s, ")"))
            : ((this.boundary = isNaN(
                parseInt(this.wrap.dataset.parallaxAmount)
              )
                ? t.amount || Math.round(innerHeight / 2)
                : parseInt(this.wrap.dataset.parallaxAmount)),
              this.boundary &&
                ...
                this.img.addEventListener("load", () => {
                  (this.img = null), this.measure(), this.update();
                }),
                window.addEventListener("resize", () => {
                  !(function (t, s) {
                    for (
                      var i = r(t),
                        a = function () {
                          clearTimeout(n[i]), delete n[i], t(...arguments);
                        },
                        e = function () {
                          for (
                            var t = arguments.length, e = new Array(t), h = 0;
                            h < t;
                            h++
                          )
                            e[h] = arguments[h];
                        ...
                        h = arguments.length,
                        o = new Array(h > 2 ? h - 2 : 0),
                        l = 2;
                      l < h;
                      l++
                    )
                      o[l - 2] = arguments[l];
                    if (1 === o.length && "prepare" === o[0]) return e;
                    e(...o);
                  })(() => {
        ...
        update() {
          if (this.margin !== this.pmargin) {
            ...
            (isNaN(t) || Math.abs(t - s) > 5) &&
              (this.css.minHeight = "".concat(s, "px")),
          ...
          if (this.parallax !== this.pparallax) {
            ...
            (this.pparallax = this.parallax),
              this.hack
                ? (this.css.transform = "translate3d(0,".concat(i, "px,0)"))
                : (this.css.transform = "translateY(".concat(i, "px)"));
          }
        }
      }
      var l = function () {
        for (
          var t =
              arguments.length > 0 && void 0 !== arguments[0]
                ? arguments[0]
                : {},
            s = a.settings(t, "[data-parallax-background],[data-parallax-bg]"),
            i = 0;
          i < s.el.length;
          ++i
        )
