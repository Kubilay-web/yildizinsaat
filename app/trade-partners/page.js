  ...
  return (
    <div>
      ...
      <link
        ...
        sizes="180x180"
        href="/trade-partners/images/apple-touch-icon.png"
      />
      <link
        rel="icon"
        type="image/png"
        sizes="32x32"
        href="/trade-partners/images/favicon-32x32.png"
      />
      <link
        rel="icon"
        type="image/png"
        sizes="16x16"
        href="/trade-partners/images/favicon-16x16.png"
      />
      <link rel="manifest" href="/site.webmanifest" />
      <link
        rel="mask-icon"
        href="/trade-partners/images/safari-pinned-tab.svg"
        color="#fdb927"
      />
      ...
      <link
        href="/public/Index-Ger/trade-partners/css/app.4d2d73d.css"
        rel="stylesheet"
      />
      <link
        rel="stylesheet"
        href="/public/Index-Ger/trade-partners/css/wic4jic.css"
      />
      ...
      />
      <title>
        Become Trade Partners of a General Contractor Near Springfield, MO
      </title>
      <meta name="generator" content="SEOmatic" />
      <meta name="keywords" content="snyder construction group" />
      <meta
        name="description"
        content="Our continued success is heavily reliant upon a team of strong trade partners. Become a trade partner by submitting a prequalification form."
      />
      ...
      <meta content="/trade-partners" property="og:url" />
      <meta
        content="Become Trade Partners of a General Contractor Near Springfield, MO"
        property="og:title"
      />
      <meta
        content="Our continued success is heavily reliant upon a team of strong trade partners. Become a trade partner by submitting a prequalification form."
      ...
      />
      <meta content="/trade-partners/images/og.jpg" property="og:image" />
      ...
      />
      <link href="/trade-partners" rel="canonical" />
          ...
          <div className="header__content" data-aos="fade-left">
            <div className="container container--lg u-color-text-white padding-v--lg">
              <h1 className="header__heading text-display-1">
                <strong>Trade Partners</strong>
              </h1>
              <div className="button-group padding-v--sm-top"></div>
            </div>
          </div>
        </div>
        <div className="chevron " data-aos="fade-down" data-aos-delay={500} />
        <section className="u-overflow-hidden ">
          <div className="container container--lg padding-v--xl">
            <div className="split-content split-content--centered">
              <div
                className="split-content__item w-full-phone w-1/2"
                data-aos="fade"
              >
                <div className="split-content__item-body">
                  <div className="text-content margin-v--sm-bottom">
                    ...
                    <p>
                      {" "}
                      Snyder Construction Group’s continued success is heavily
                      reliant upon a team of strong trade partners. Our
                      prequalification process allows us to efficiently identify
                      and track the credentials, capabilities, services, and
                      skillsets of our trade partners. Become a valued trade
                      partner of the Snyder Construction Group by submitting a
                  ...
                  <div className="button-group">
                    <a
                      ...
                      href="https://asset.snydercg.com/SCG-Trade-Partner-Prequalification-Form.pdf?mtime=20210318181355&focal=none"
              ...
              <div
                className="split-content__item w-full-phone w-1/2 u-text-align-center"
                data-aos="fade"
              >
                <div className="wipe-in">
                  <img
                    src="/trade-partners/images/trade-partners.jpg"
                    alt="Man working with a hammer as a trade partner of a general contractor."
                  />
                </div>
              </div>
            </div>
          ...
          >
            ...
            <div className="button-group padding-v--md-top">
              <a
                ...
                href="https://snydercg.com/contact"
              >
                Get in Touch
              </a>
            </div>
